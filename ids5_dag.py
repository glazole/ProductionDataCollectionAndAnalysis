...
def ids5_table_dates(**kwargs):
    ...
    query1 = """
         SELECT
         *
         FROM ids5_table_dates_with_error
    """
    ...
    column_renames = {
        ...
        'Ошибка_1 - Ошибка на канале': 'error_channel',
        'Ошибка_1 - Номер ошибки': 'error_number',
        'Ошибка_1 - Время': 'error_time',
        'Ошибка_1 - Текст': 'error_text',
        'Ошибка_1 - Описание': 'error_description',
        'Ошибка_1 - Что сделать': 'error_action',
    ...
    data.to_sql('ids5_table', engine, if_exists='replace', index=False)

# Определение DAG
with DAG(
    dag_id="ids5_table_dates",
    ...
    process_data = PythonOperator(
        task_id="process_ids5_table_dates",
        python_callable=ids5_table_dates,
